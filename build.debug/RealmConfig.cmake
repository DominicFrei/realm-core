...
if(REALM_NEEDS_OPENSSL)
    if(REALM_USE_SYSTEM_OPENSSL)
        # Use system OpenSSL
        find_dependency(OpenSSL VERSION )
    else()
        # Use our OpenSSL
        if(NOT OpenSSL_DIR)
            if(NOT EXISTS ${CMAKE_BINARY_DIR}/openssl/lib/cmake/OpenSSL/OpenSSLConfig.cmake)
                if(ANDROID)
                    set(OPENSSL_URL "http://static.realm.io/downloads/openssl/1.1.1g/Android/${CMAKE_ANDROID_ARCH_ABI}/openssl.tar.gz"")
                else()
                    set(OPENSSL_URL "http://static.realm.io/downloads/openssl/1.1.1g/Linux/x86_64/openssl.tar.gz"")
                endif()
